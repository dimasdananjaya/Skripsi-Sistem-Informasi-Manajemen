                            ...
                            <li class="nav-item">
                                    <div class="dropdown">
                                            ...
                                            <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                                <a class="dropdown-item" href="/login">Petugas Dinas</a>
                                                <a class="dropdown-item" href="/login">Kepala Bidang</a>
                                                <a class="dropdown-item" href="/petugas_uml">Petugas UML</a>
                                            </div>
                                        </div>  
                            </li>
                        @else
                            <li class="nav-item dropdown">
                                ...
                                <div class="dropdown-menu dropdown-menu-right" aria-labelledby="navbarDropdown">
                                    ...
                                    <a class="dropdown-item" href="{{ url('/kepala_bidang') }}">
                                        Dashboard
                                     </a>
                                </div>
                            </li>
